...
import (
	...
	kubekeyclientset "github.com/yunfeigj/kubevity/clients/clientset/versioned"
	kubekeycontroller "github.com/yunfeigj/kubevity/controllers/kubevity"
	"github.com/yunfeigj/kubevity/pkg/addons"
	"github.com/yunfeigj/kubevity/pkg/config"
	"github.com/yunfeigj/kubevity/pkg/container-engine/docker"
	"github.com/yunfeigj/kubevity/pkg/etcd"
	"github.com/yunfeigj/kubevity/pkg/hadoop"
	"github.com/yunfeigj/kubevity/pkg/plugins/network"
	"github.com/yunfeigj/kubevity/pkg/util"
	"github.com/yunfeigj/kubevity/pkg/util/executor"
	"github.com/yunfeigj/kubevity/pkg/util/manager"
...
func CreateCluster(clusterCfgFile, k8sVersion, ksVersion string, logger *log.Logger, ksEnabled, verbose, skipCheck, skipPullImages, inCluster, deployLocalStorage bool, downloadCmd string) error {
	...
	if err := util.CreateDir(fmt.Sprintf("%s/kubevity", currentDir)); err != nil {
