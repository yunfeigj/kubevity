...
import (
	"fmt"
	"github.com/yunfeigj/kubevity/apis/kubevity/v1alpha1"
	"github.com/yunfeigj/kubevity/pkg/cluster/install"
	"github.com/yunfeigj/kubevity/pkg/util"
	"github.com/yunfeigj/kubevity/version"
...
var clusterCmd = &cobra.Command{
	Use:   "cluster",
	Short: "Create a Kubernetes or Hadoop cluster",
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return install.CreateCluster(opt.ClusterCfgFile, opt.Kubernetes, hdVersion, logger, opt.Kubesphere, opt.Verbose, opt.SkipCheck, opt.SkipPullImages, opt.InCluster, opt.LocalStorage, opt.DownloadCmd)
	},
}
